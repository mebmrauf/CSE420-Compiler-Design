...
%token IF ELSE FOR WHILE DO BREAK CONTINUE RETURN INT FLOAT CHAR DOUBLE VOID SWITCH CASE DEFAULT PRINTLN GOTO ADDOP MULOP INCOP DECOP RELOP ASSIGNOP LOGICOP NOT LPAREN RPAREN LCURL RCURL LTHIRD RTHIRD COMMA COLON SEMICOLON ID CONST_INT CONST_FLOAT
%nonassoc IF ELSE RELOP LOGICOP
...
int main(int argc, char *argv[])
{
	...
	yyin = fopen(argv[1], "r");
	outlog.open("22201782+22101783.txt", ios::trunc);
